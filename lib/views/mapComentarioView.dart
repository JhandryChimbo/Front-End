...
class MapComentarioView extends StatefulWidget {
  final String animeId;

  const MapComentarioView({Key? key, required this.animeId}) : super(key: key);

  @override
  _MapComentarioViewState createState() => _MapComentarioViewState();
}

class _MapComentarioViewState extends State<MapComentarioView> {
